...
| 4. OD 条件化双向 NBFNet | 进行中，统一数据与 MLP 基线已完成 | 完成 GPU GraphSAGE 节点打分和核心 72 组验证集消融；第二版已完成精确端点局部接入、固定候选、1,200×2,000 真实标签、128 个需求原型的统一数据接口和五种子无传播 MLP，下一步实现 OD 条件化双向 Neural Bellman-Ford 区域价值网络。 |
