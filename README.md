...
工具 + 图算法与 AI”定位，赛题契合度、交付清单和论文路线见
...
| 5. 梯度稳定化与 Z0 神经残差 | G3 衰减版 S3/S4 运行中 | G3 恒定 `5e-3` 三种子 Spearman 平均超过 Z0，但 NDCG@5 平均门未过；当前只补一次 plateau 衰减对照，P 线后移。 |
| 6. 最终对比实验 | 未开始 | 待阶段五冻结最终方法后，再补同预算对比、未来窗口、非重叠集合选择和跨城市验证。 |
