...
| 4. OD 条件化双向 NBFNet | 进行中，基础模型正式五种子已完成 | 完成精确端点局部接入、固定候选、1,200×2,000 真实标签、128 个需求原型、五种子无传播 MLP 和 RTX 5060 Ti 基础 NBFNet 五种子训练。NBFNet 的 holdout NDCG@K 为 0.9821，Top-K 收益为 129.051，均超过 MLP 与原始频率；下一步运行核心传播与拓扑消融。 |
