...
| 8. C++ 高性能复核 | 已完成 | 同一 C++20/O3 实现完成两城 560,000 个正式计时配对；Porto Z0 平均加速 6.5%～7.5%，Chicago 的平均耗时改善受 shortcut 扫边开销限制，但多数 P95 改善。 |
...
约 20% 的展开节点减少使 14 个组合中 11 个 P95 下降；平均耗时改善则受密集 shortcuts 的
`18%～28%` 额外扫边开销限制。
