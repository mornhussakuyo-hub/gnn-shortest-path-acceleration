...
ARCHIVE_DIR = ROOT_DIR / "archive" / "gnn_v1"
DEFAULT_OUTPUT_DIR = ARCHIVE_DIR / "results" / "gnn_ablation"
TRAIN_SCRIPT = ARCHIVE_DIR / "scripts" / "train_gnn_seed_model.py"
EVALUATE_SCRIPT = ARCHIVE_DIR / "scripts" / "evaluate_gnn_seed_model.py"
NON_LEARNING_SCORE_SCRIPT = ARCHIVE_DIR / "scripts" / "generate_non_learning_seed_scores.py"
